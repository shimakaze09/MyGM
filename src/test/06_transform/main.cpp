...
int main() {
  ...
  cout << transformf::rotate_with<Axis::X>(to_radian(180.f))
              .decompose_quatenion()
       << endl;
  auto trs = transformf{vecf3{1.f}, quatf{vecf3{1, 1, 1}, to_radian(45.f)},
                        scalef3{2.f, 3.f, 4.f}};
  ...
  matf3 m3{-0.558253, -0.0461681, -0.505735,  -0.411397, 0.0365854,
           0.199707,  0.285389,   -0.3137890, 0.200189};
