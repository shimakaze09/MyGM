...
namespace My {
/**
 * @brief Interface for 1D array-like structures.
 *
 * This interface provides common functionality for 1D arrays, such as vectors.
 * It serves as a base for more specific interfaces.
 *
 * @tparam Base The base class in the CRTP hierarchy.
 * @tparam Impl The concrete implementation class.
 */
...
/**
 * @brief Enumeration for array modes.
 *
 * Used to determine the storage and optimization strategy for arrays based on their dimension
 * and SIMD support.
 */
...
/**
 * @brief Determines the array mode for a given implementation.
 *
 * @tparam Impl The implementation class.
 * @return The ArrayMode corresponding to the implementation's traits.
 */
...
struct IStdArrayBasic : Base {
  ...
  std::array<T, N>& to_array() noexcept {
    return reinterpret_cast<std::array<T, N>&>(*this);
  }

  const std::array<T, N>& to_array() const noexcept {
    return const_cast<IStdArrayBasic*>(this)->to_array();
  }
  ...
  const T* data() const noexcept {
    return const_cast<IStdArrayBasic*>(this)->data();
  }
};

template <typename Base, typename Impl>
struct alignas(alignof(SI_ImplTraits_T<Impl>)) IStdArray
    : IStdArrayBasic<Base, Impl> {
  using T = SI_ImplTraits_T<Impl>;
  using F = SI_ImplTraits_F<Impl>;
  static constexpr std::size_t N = SI_ImplTraits_N<Impl>;
...
struct IArrayCommon : IStdArray<Base, Impl> {
 ...
 public:
  ...
  constexpr IArrayCommon(const T* arr) noexcept
      : IArrayCommon{arr, std::make_index_sequence<N>{}} {}

  constexpr IArrayCommon(const Impl& arr) noexcept
      : IArrayCommon{arr, std::make_index_sequence<N>{}} {}

  constexpr IArrayCommon(const T& t) noexcept
      : IArrayCommon{t, std::make_index_sequence<N>{}} {}

  static constexpr Impl zero() noexcept { return Impl{T{static_cast<F>(0)}}; }
...
struct SwizzleImpl<true, true, Impl, Ns...> : SwizzleImplBase<Impl, Ns...> {
  ...
  auto to_impl() const { return ImplN{this->template get<Ns>()...}; }

  operator ImplN() const { return to_impl(); }
};

template <typename Impl, std::size_t... Ns>
struct SwizzleImpl<false, true, Impl, Ns...>
    : SwizzleImpl<true, true, Impl, Ns...> {
  using ImplN = SI_ImplTraits_ImplN<Impl, sizeof...(Ns)>;

  Impl& operator=(const ImplN& rhs) noexcept {
    constexpr auto assign_impl = []<std::size_t... Ms>(
                                     Impl& lhs, const ImplN& rhs,
                                     std::index_sequence<Ms...>) -> Impl& {
...
#define MYGM_ARRAY_SWIZZLE2_2(EI0, EI1, E0, E1) \
...
#define MYGM_ARRAY_SWIZZLE3_3(EI0, EI1, EI2, E0, E1, E2) \
...
#define MYGM_ARRAY_SWIZZLE4_4(EI0, EI1, EI2, EI3, E0, E1, E2, E3) \
...
#define MYGM_ARRAY_SWIZZLE3_2(EI0, EI1, EI2, E0, E1, E2) \
  My::details::Swizzle<Impl, EI0, EI0> E0##E0;           \
  My::details::Swizzle<Impl, EI0, EI1> E0##E1;           \
...
#define MYGM_ARRAY_SWIZZLE4_2(EI0, EI1, EI2, EI3, E0, E1, E2, E3) \
  My::details::Swizzle<Impl, EI0, EI0> E0##E0;                    \
  My::details::Swizzle<Impl, EI0, EI1> E0##E1;                    \
  My::details::Swizzle<Impl, EI0, EI2> E0##E2;                    \
...
#define MYGM_ARRAY_SWIZZLE4_3(EI0, EI1, EI2, EI3, E0, E1, E2, E3) \
  My::details::Swizzle<Impl, EI0, EI0, EI0> E0##E0##E0;           \
  My::details::Swizzle<Impl, EI0, EI0, EI1> E0##E0##E1;           \
  My::details::Swizzle<Impl, EI0, EI0, EI2> E0##E0##E2;           \
...
#define MYGM_ARRAY_SWIZZLE2(E0, E1) MYGM_ARRAY_SWIZZLE2_2(0, 1, E0, E1)

#define MYGM_ARRAY_SWIZZLE3(E0, E1, E2)       \
  MYGM_ARRAY_SWIZZLE3_2(0, 1, 2, E0, E1, E2); \
  MYGM_ARRAY_SWIZZLE3_3(0, 1, 2, E0, E1, E2)

#define MYGM_ARRAY_SWIZZLE4(E0, E1, E2, E3)          \
  MYGM_ARRAY_SWIZZLE4_2(0, 1, 2, 3, E0, E1, E2, E3); \
  MYGM_ARRAY_SWIZZLE4_3(0, 1, 2, 3, E0, E1, E2, E3); \
  MYGM_ARRAY_SWIZZLE4_4(0, 1, 2, 3, E0, E1, E2, E3)
...
struct IArray_Impl<details::ArrayMode::Two, IArray_Base, Impl>
  ...
  union {
    ...
    MYGM_ARRAY_SWIZZLE2(x, y);
    MYGM_ARRAY_SWIZZLE2(r, g);
    MYGM_ARRAY_SWIZZLE2(s, t);
  };

  using details::IArrayCommon<IArray_Base, Impl>::IArrayCommon;

  template <typename... Us, std::enable_if_t<sizeof...(Us) == 2, int> = 0>
  constexpr IArray_Impl(Us... vals) noexcept
...
struct IArray_Impl<details::ArrayMode::Three, IArray_Base, Impl>
  ...
  union {
    ...
    MYGM_ARRAY_SWIZZLE3(x, y, z);
    MYGM_ARRAY_SWIZZLE3(r, g, b);
    MYGM_ARRAY_SWIZZLE3(s, t, p);
  };
...
struct IArray_Impl<details::ArrayMode::Four, IArray_Base, Impl>
  ...
  union {
    ...
    MYGM_ARRAY_SWIZZLE4(x, y, z, w);
    MYGM_ARRAY_SWIZZLE4(r, g, b, a);
    MYGM_ARRAY_SWIZZLE4(s, t, p, q);
  };
...
struct alignas(16) IArray_Impl<details::ArrayMode::Four_SIMD, IArray_Base, Impl>
 ...
 public:
  ...
  IArray_Impl& operator=(const IArray_Impl& f4) noexcept {
    m = f4.m;
    return *this;
  }
  ...
  operator const __m128&() const noexcept {
    return const_cast<IArray_Impl*>(this)->operator __m128&();
  }

  IArray_Impl(float x, float y, float z, float w) noexcept
      : m{_mm_set_ps(w, z, y, x)} {}  // little-endianness

  template <typename Ux, typename Uy, typename Uz, typename Uw>
  IArray_Impl(Ux x, Uy y, Uz z, Uw w) noexcept
      : IArray_Impl{static_cast<float>(x), static_cast<float>(y),
                    static_cast<float>(z), static_cast<float>(w)} {}

  static Impl zero() noexcept { return _mm_setzero_ps(); }
