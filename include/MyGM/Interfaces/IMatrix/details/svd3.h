...
// A = UP
inline void pd(float a11, float a12, float a13, float a21, float a22, float a23,
               float a31, float a32, float a33,
               // output U
               float& u11, float& u12, float& u13, float& u21, float& u22,
               float& u23, float& u31, float& u32, float& u33,
               // output P
               float& p11, float& p12, float& p13, float& p21, float& p22,
               float& p23, float& p31, float& p32, float& p33) {
