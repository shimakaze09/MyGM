...
inline rgbf fresnel_schlick(float cos_theta, float metalness,
...
inline const rgbf specular_reflection(const rgbf& Fr,
                                      float cos_theta) noexcept {
  return Fr / cos_theta;
}
...
inline float specular_refraction(float Fr, float eta,
