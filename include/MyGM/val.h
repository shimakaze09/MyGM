...
struct val
    : SI<TemplateList<IArrayLinear, IArrayHadamardProduct, IArray1D_Util>,
         val<T, N>, TypeList<T, Size<N>>, T> {
  using SI<TemplateList<IArrayLinear, IArrayHadamardProduct, IArray1D_Util>,
           val<T, N>, TypeList<T, Size<N>>, T>::SI;
