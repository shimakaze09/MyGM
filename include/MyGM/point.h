...
struct point : SI<TemplateList<IArray1D_Util, IEuclideanA>, point<T, N>,
                  TypeList<T, Size<N>>, T, vec<T, N>, point<T, N>> {
  using SI<TemplateList<IArray1D_Util, IEuclideanA>, point<T, N>,
           TypeList<T, Size<N>>, T, vec<T, N>, point<T, N>>::SI;
