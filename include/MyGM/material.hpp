...
// - metalness: 0 - 1
// - metal_color: maybe call 'albedo' in model files, the word 'albedo' is for
// lambertian reflection [return] specular reflection coefficient
...
// Microfacet-Based BRDFs. [argument]
